...
Users can define seperate stages which share the same positional identifier as seen in \ref{lis}
...
The example shown in \ref{lis:vliw-in-out-syntax} illutrates how one would link an output from \texttt{STAGE\_0}
to \texttt{STAGE\_1}. 
