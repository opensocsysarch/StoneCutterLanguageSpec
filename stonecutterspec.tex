...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{StoneCutter Language Spec v.0.7}}  % -- classification
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{StoneCutter Language Spec v.0.7}}  % -- classification
...
\begin{center}
\begin{tabular}{l r}
Date: & February 03, 2021 \\ % Date the experiment was performed
Revision: & 0.7 \\         % revision number
