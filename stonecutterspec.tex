...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{StoneCutter Language Spec v.0.5}}  % -- classification
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{StoneCutter Language Spec v.0.5}}  % -- classification
...
\begin{center}
\begin{tabular}{l r}
Date: & October 15, 2019 \\ % Date the experiment was performed
Revision: & 0.5 \\         % revision number
