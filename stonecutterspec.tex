...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{StoneCutter Language Spec v.0.4}}  % -- classification
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{StoneCutter Language Spec v.0.4}}  % -- classification
...
\begin{center}
\begin{tabular}{l r}
Date: & May 21, 2019 \\ % Date the experiment was performed
Revision: & 0.4 \\         % revision number
...
\begin{versionhistory}
  ...
  \vhEntry{0.4}{05.21.2019}{JLeidel}{Updating format for SEXT and ZEXT intrinsics}
\end{versionhistory}
\clearpage
...
\hline
\hyperref[sec:SEXT]{\texttt{SEXT}} & 2 & 1 & Sign extend\\
\hline
\hyperref[sec:ZEXT]{\texttt{ZEXT}} & 2 & 2 & Zero extend\\
\hline
