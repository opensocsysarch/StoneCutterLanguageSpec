...
\pagestyle{fancy}
\lhead{}
\chead{\textbf{StoneCutter Language Spec v.0.6}}  % -- classification
\rhead{}
\lfoot{} %-- format: TR YYYY-RRR-V.V; y = year; r = report; v = version
\cfoot{\textbf{StoneCutter Language Spec v.0.6}}  % -- classification
...
\begin{center}
\begin{tabular}{l r}
Date: & March 23, 2020 \\ % Date the experiment was performed
Revision: & 0.6 \\         % revision number
